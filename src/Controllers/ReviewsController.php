...
class ReviewsController extends Controller {
    ...
    public function reply() {
        ...
        try {
            if (!isset($_SESSION['user_id'])) throw new \Exception('Login necessário.');
            ...
            if (!$reviewId || empty($replyText)) throw new \Exception('Resposta vazia.');
    ...
    public function delete() {
        ...
        try {
            if (!isset($_SESSION['user_id'])) throw new \Exception('Acesso negado.');
