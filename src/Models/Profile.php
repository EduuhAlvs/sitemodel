...
class Profile {
    ...
    // ... (Métodos getById, isOwner, update, getBySlug mantidos) ...
    ...
    public static function getBySlug(string $slug) {
        ...
        try { $db->getConnection()->prepare("UPDATE profiles SET views_count = views_count + 1 WHERE id = :id")->execute(['id' => $profile['id']]); } catch (\Exception $e) {}
        return $profile;
    }
